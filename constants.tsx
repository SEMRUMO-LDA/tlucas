...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    why_point2_title: "SUPPORT ON COSTA VICENTINA TRAILS",
    ...
    why_point3_desc: "We know the access points, schedules, and the right pickup spots. This way, we avoid delays, confusion, and hard-to-reach locations.",
    about_tag: "HOW WE WORK",
    about_title_1: "WELL-ORGANIZED",
    about_title_2: "TRANSFERS",
    about_title_3: "NO COMPLICATIONS",
    about_desc: "We plan every transfer based on your journey. This results in less waiting, fewer questions, and fewer unexpected issues.",
    about_exp: "Years of experience",
    about_feat1: "Flight and schedule monitoring",
    about_feat2: "Clear, fixed prices defined at the start",
    ...
    contact_hub_value: "Costa Vicentina &\nAlgarve, Portugal",
    ...
    footer_desc: "Transfers in the Algarve and the Costa Vicentina for airport arrivals, stage-by-stage hiking, and cycling routes. Simple organization, direct support, and local knowledge.",
  ...
  pt: {
    ...
    why_point2_title: "APOIO EM PERCURSOS NA COSTA VICENTINA",
    ...
    why_point3_desc: "Conhecemos acessos, horários e pontos certos de recolha. Assim evitamos atrasos, confusões e locais difíceis de chegar.",
    about_tag: "COMO TRABALHAMOS",
    about_title_1: "TRANSFERS BEM",
    about_title_2: "ORGANIZADOS",
    about_title_3: "SEM COMPLICAÇÕES",
    about_desc: "Planeamos cada transfer com base na sua viagem. Isso significa menos esperas, menos dúvidas e menos imprevistos.",
    about_exp: "anos de experiência",
    about_feat1: "Acompanhamento de voos e horários",
    about_feat2: "Preços claros e definidos à partida",
    ...
    footer_desc: "Transfers no Algarve e na Costa Vicentina para chegadas ao aeroporto, caminhadas por etapas e percursos de bicicleta. Organização simples, apoio direto e conhecimento local.",
